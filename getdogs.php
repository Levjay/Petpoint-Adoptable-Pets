<?php
	...
	$data = array('authkey' => '[YOUR AUTHKEY HERE]', 'site' => '[YOUR SITE HERE]', 
		'speciesID' => '1', 'sex' => $sex, 'ageGroup' => $age, 'location' => $location, 'onHold' => '', 'orderBy' => 'Name', 
...
//	print_r($result);
	...
	foreach($pets->XmlNode as $petinfo){
		...
		array_push($arrayRet, json_encode(array((string)$id, (string)$pic, (string)$name, (string)$breed, (string)$sbreed, (string)$sex, (string)$age, (string)$location)));
	}
